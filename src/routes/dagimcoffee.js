...
async function main(payload, contractCount) {
    ...
    let info = await transporter.sendMail({
        ...
        to: `nathygech111@gmail.com, ${payload.email}`, // list of receivers atnbuildingmaterial1@gmail.com
                ...
                <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
                    <tr>
                        <td valign="top" class="bg_white" style="padding: 1em 2.5em 0 2.5em;">
                            <a href="https://dagimcoffee.com"><img style="width: 250px; max-width: 600px; height: auto; margin-bottom: 20px; display: block;" src="https://samvisionapi.herokuapp.com/thumbs/logo.png" width="" alt=""></a>
                        ...
                        <table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                                ...
                                <td valign="middle" width="20%" style="text-align:left; padding: 0 2.5em;">
                                    <span class="price" style="color: #000; font-size: 15px;">${payload.type}</span>
                                </td>
                                <td valign="middle" width="20%" style="text-align:left; padding: 0 2.5em;">
                            ...
                            <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                                ...
                                <td valign="middle" width="20%" style="text-align:left; padding: 0 2.5em;">
                                    <span class="price" style="color: #000; font-size: 15px;"></span>
                                </td>
                                <td valign="middle" width="20%" style="text-align:left; padding: 0 2.5em;">
                                    <span class="price" style="color: #000; font-size: 15px;"></span>
                                </td>
                                ...
                                <td valign="middle" width="20%" style="text-align:left; padding: 0 2.5em;">
                                    <span class="price" style="color: #000; font-size: 15px;">1220</span>
                                </td>
                            </tr>
                        </table>
                    </tr><!-- end tr -->
...
const tagRepeater = function(payload)  {
    // repeat from the items list and create a table with total quantity and price (amount)
}
